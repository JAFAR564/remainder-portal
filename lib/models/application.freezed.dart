...
mixin _$Application {
 ...
 String get id;@JsonKey(name: 'submitted_at') String get submittedAt;@JsonKey(name: 'applicant_email') String get applicantEmail;@JsonKey(name: 'character_name') String get characterName; String get faction; List<String> get answers; String get status;
...
@useResult
$Res call({
 String id,@JsonKey(name: 'submitted_at') String submittedAt,@JsonKey(name: 'applicant_email') String applicantEmail,@JsonKey(name: 'character_name') String characterName, String faction, List<String> answers, String status
});
...
/// Create a copy of Application
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? submittedAt = null,Object? applicantEmail = null,Object? characterName = null,Object? faction = null,Object? answers = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'submitted_at')  String submittedAt, @JsonKey(name: 'applicant_email')  String applicantEmail, @JsonKey(name: 'character_name')  String characterName,  String faction,  List<String> answers,  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Application() when $default != null:
return $default(_that.id,_that.submittedAt,_that.applicantEmail,_that.characterName,_that.faction,_that.answers,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'submitted_at')  String submittedAt, @JsonKey(name: 'applicant_email')  String applicantEmail, @JsonKey(name: 'character_name')  String characterName,  String faction,  List<String> answers,  String status)  $default,) {final _that = this;
switch (_that) {
case _Application():
return $default(_that.id,_that.submittedAt,_that.applicantEmail,_that.characterName,_that.faction,_that.answers,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'submitted_at')  String submittedAt, @JsonKey(name: 'applicant_email')  String applicantEmail, @JsonKey(name: 'character_name')  String characterName,  String faction,  List<String> answers,  String status)?  $default,) {final _that = this;
switch (_that) {
case _Application() when $default != null:
return $default(_that.id,_that.submittedAt,_that.applicantEmail,_that.characterName,_that.faction,_that.answers,_that.status);case _:
  return null;
...
class _Application implements Application {
  const _Application({required this.id, @JsonKey(name: 'submitted_at') required this.submittedAt, @JsonKey(name: 'applicant_email') required this.applicantEmail, @JsonKey(name: 'character_name') required this.characterName, required this.faction, required final  List<String> answers, required this.status}): _answers = answers;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Application&&(identical(other.id, id) || other.id == id)&&(identical(other.submittedAt, submittedAt) || other.submittedAt == submittedAt)&&(identical(other.applicantEmail, applicantEmail) || other.applicantEmail == applicantEmail)&&(identical(other.characterName, characterName) || other.characterName == characterName)&&(identical(other.faction, faction) || other.faction == faction)&&const DeepCollectionEquality().equals(other._answers, _answers)&&(identical(other.status, status) || other.status == status));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,submittedAt,applicantEmail,characterName,faction,const DeepCollectionEquality().hash(_answers),status);
...
/// Create a copy of Application
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? submittedAt = null,Object? applicantEmail = null,Object? characterName = null,Object? faction = null,Object? answers = null,Object? status = null,}) {
