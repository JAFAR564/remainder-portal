...
mixin _$RosterMember {
  ...
  String get faction;
  @JsonKey(name: 'faceclaim_name')
  String get faceclaimName;
  @JsonKey(name: 'faceclaim_img_url')
  String get faceclaimImgUrl;
  String get status;
  ...
  $RosterMemberCopyWith<RosterMember> get copyWith =>
      _$RosterMemberCopyWithImpl<RosterMember>(
          this as RosterMember, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.faceclaimName, faceclaimName) ||
                other.faceclaimName == faceclaimName) &&
            (identical(other.faceclaimImgUrl, faceclaimImgUrl) ||
                other.faceclaimImgUrl == faceclaimImgUrl) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, characterName, playerName,
      faction, faceclaimName, faceclaimImgUrl, status, joinedDate);
...
abstract mixin class $RosterMemberCopyWith<$Res> {
  factory $RosterMemberCopyWith(
          RosterMember value, $Res Function(RosterMember) _then) =
      _$RosterMemberCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      ...
      String faction,
      @JsonKey(name: 'faceclaim_name') String faceclaimName,
      @JsonKey(name: 'faceclaim_img_url') String faceclaimImgUrl,
      String status,
      @JsonKey(name: 'joined_date') String joinedDate});
}

/// @nodoc
class _$RosterMemberCopyWithImpl<$Res> implements $RosterMemberCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? faction = null,
    Object? faceclaimName = null,
    Object? faceclaimImgUrl = null,
    Object? status = null,
    ...
    return _then(_self.copyWith(
      ...
      faction: null == faction
          ...
          : faction // ignore: cast_nullable_to_non_nullable
              as String,
      faceclaimName: null == faceclaimName
          ? _self.faceclaimName
          : faceclaimName // ignore: cast_nullable_to_non_nullable
              as String,
      faceclaimImgUrl: null == faceclaimImgUrl
          ? _self.faceclaimImgUrl
          : faceclaimImgUrl // ignore: cast_nullable_to_non_nullable
              as String,
      status: null == status
          ? _self.status
...
extension RosterMemberPatterns on RosterMember {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_RosterMember value)? $default, {
...
class _RosterMember implements RosterMember {
  const _RosterMember(
      ...
      @JsonKey(name: 'faceclaim_name') required this.faceclaimName,
      @JsonKey(name: 'faceclaim_img_url') required this.faceclaimImgUrl,
      required this.status,
      @JsonKey(name: 'joined_date') required this.joinedDate});
  factory _RosterMember.fromJson(Map<String, dynamic> json) =>
  ...
  @override
  @JsonKey(name: 'faceclaim_name')
  final String faceclaimName;
  @override
  @JsonKey(name: 'faceclaim_img_url')
  final String faceclaimImgUrl;
  @override
  final String status;
  @override
  @JsonKey(name: 'joined_date')
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$RosterMemberCopyWith<_RosterMember> get copyWith =>
      __$RosterMemberCopyWithImpl<_RosterMember>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$RosterMemberToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$RosterMemberCopyWith<$Res>
    implements $RosterMemberCopyWith<$Res> {
  factory _$RosterMemberCopyWith(
          _RosterMember value, $Res Function(_RosterMember) _then) =
      __$RosterMemberCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
