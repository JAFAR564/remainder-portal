                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            labelStyle: const TextStyle(color: Color(0xFFB8860B), fontSize: 10),
                            filled: true,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        guild.announcement,
                        style: const TextStyle(color: Color(0xFF666666), fontSize: 11, fontStyle: FontStyle.italic),
                      ),
                    ],
                  ),
                ),
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        title: Text(m.userName, style: const TextStyle(color: Color(0xFF1A1A1A), fontSize: 12, fontWeight: FontWeight.bold, fontFamily: 'serif')),
                        subtitle: Text('Joined: ${m.joinedDate.toIso8601String().substring(0, 10)}', style: const TextStyle(color: Color(0xFF777777), fontSize: 10)),
                        trailing: Container(
                          padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                          decoration: BoxDecoration(
                            color: const Color(0xFFD4AF37).withValues(alpha: 0.15),
                          ...
                          child: Text(m.rank, style: const TextStyle(color: Color(0xFFB8860B), fontSize: 9, fontWeight: FontWeight.bold, fontFamily: 'monospace')),
                        ),
                      ),
                    );
                  },
