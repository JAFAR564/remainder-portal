              ...
              RotationTransition(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: Colors.white,
                    border: Border.all(color: const Color(0xFFA78D78), width: 2.5),
                    boxShadow: [
                      BoxShadow(
                  ...
                  child: Stack(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          border: Border.all(color: const Color(0xFF6E473B).withValues(alpha: 0.5), width: 1.5),
                        ),
                      ),
                      const Icon(Icons.hub_outlined, color: Color(0xFF6E473B), size: 36),
                    ],
                  ),
                ),
              ),
